...
public class BeatBoxFinal {  // implements MetaEventListener
    ...
    public static void main (String[] args)
    {
        ...
        if (args.length < 1) {
            ...
            new BeatBoxFinal().startUp("You ");}
       /* if (args.length >= 1) {
            new BeatBoxFinal().startUp(args[0]);
            //C:\Program Files (x86)\Javarush\JavaRushHomeWork\out\production\JavaRushHomeWork>java BeatBoxFinale.BeatBoxFinal Sasha

        } else{

            javax.swing.JOptionPane.showConfirmDialog(null,
                    "Пожалуйста введите аргумент","Неправильный ввод",
...
//============================================================== inner class listeners
    ...
    public class MySendListener implements ActionListener {    // new - save
        public void actionPerformed(ActionEvent a) {
            ...
            try {
                FileOutputStream fileStream = new FileOutputStream(new File(String.valueOf(saveFile)));
    ...
    public class BoxListener implements ItemListener{
        ...
        public void itemStateChanged(ItemEvent e) {
            ...
            userMessage.setText((String)box.getSelectedItem());
            String str = (String)box.getSelectedItem();

            if(str.equals("Beat")) {

                File fileBeat = new File("C:\\Users\\Sasha\\Documents\\Beat");


                boolean[] checkboxState = null;
                try
                {
                    FileInputStream fileIn = new FileInputStream(new File(String.valueOf(fileBeat)));
                    ObjectInputStream is = new ObjectInputStream(fileIn);
                    checkboxState = (boolean[]) is.readObject();
                }
                catch (Exception ex)
                ...
                File fileJazz = new File("C:\\Users\\Sasha\\Documents\\Jazz");

                boolean[] checkboxState = null;
                try
                {
                    FileInputStream fileIn = new FileInputStream(new File(String.valueOf(fileJazz)));
                    ObjectInputStream is = new ObjectInputStream(fileIn);
                    checkboxState = (boolean[]) is.readObject();
                }
                catch (Exception ex)
